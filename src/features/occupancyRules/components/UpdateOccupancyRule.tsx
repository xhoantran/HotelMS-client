...
export function UpdateOccupancyRule(props: UpdateOccupancyRuleProps) {
  ...
  const defaultValues = {
    ...
    factor: props.occupancyRule.incrementFactor !== 0 ? props.occupancyRule.incrementFactor : props.occupancyRule.percentageFactor,
  ...
  return (
    <>
      {open ? (
        ...
        <>
          <tr key={props.occupancyRule.uuid} className="border-t border-gray-200">
            ...
            <td className="py-3 px-3 text-right text-sm font-medium">
              ...
              >
                Edit<span className="sr-only">, {props.occupancyRule.uuid}</span>
              </button>
            </td>
          </tr>
        </>
