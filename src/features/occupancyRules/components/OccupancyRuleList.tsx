...
export function OccupancyRuleList(props: IOccupancyRuleListProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
      <div>
        <h2 className="text-base font-semibold leading-7 text-gray-900">Occupancy Based Trigger Rules</h2>
      ...
      <div className={clsx(
          ...
          !isOccupancyBased && "opacity-50 cursor-not-allowed"
        )}
      >
        <div className="col-span-5">
          <div className="ring-1 ring-gray-300 sm:mx-0 rounded-md sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-300">
              <thead>
                <tr>
                  <th scope="col" className="w-1/4 py-3 pl-3 text-center text-sm font-semibold text-gray-900">
                    Occupancy
                  </th>
                  <th scope="col" className="w-2/4 py-3 px-3 text-center text-sm font-semibold text-gray-900">
                    Factor
                  </th>
