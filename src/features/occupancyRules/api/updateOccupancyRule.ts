...
export const updateOccupancyRule = async (occupancyRuleDto: UpdateOccupancyRuleDTO): Promise<IOccupancyBasedTriggerRule> => {
...
export const useUpdateOccupancyRule = ({ config }: useUpdateOccupancyRuleOptions = {}) => {
