...
export const createHotel = async (hotelDto: CreateHotelDTO): Promise<IHotel> => {
  const { data } = await axiosInstance.post("/api/v1/pms/hotel/", snakify(hotelDto.data)) as { data: IHotel };
