...
interface DeleteTimeRuleProps {
  timeRule: ITimeBasedTriggerRule
}

export function DeleteTimeRule(props: DeleteTimeRuleProps) {
  const [open, setOpen] = useState(false)
  const cancelButtonRef = useRef(null)

  const deleteTimeRuleMutation = useDeleteTimeRule({
    dynamicPricingSettingUuid: props.timeRule.setting
  })
                  ...
                  <Dialog.Panel className="relative overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        >
                          Are you sure you want to delete this time rule?
                        </Dialog.Title>
                        <div className="mt-2">
                    ...
                    <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                      <button
                        ...
                        className={clsx(
                          ...
                          deleteTimeRuleMutation.isLoading &&
                            'cursor-not-allowed opacity-50'
                        )}
                        onClick={() => {
                          deleteTimeRuleMutation
                            .mutateAsync({
