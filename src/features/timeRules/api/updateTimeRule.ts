...
export const updateTimeRule = async (timeRuleDto: UpdateTimeRuleDTO): Promise<ITimeBasedTriggerRule> => {
...
export const useUpdateTimeRule = ({ config }: useUpdateTimeRuleOptions = {}) => {
